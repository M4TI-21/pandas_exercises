...
![png](Exercise%204_files/Exercise%204_30_0.png)
...
![png](Exercise%204_files/Exercise%204_34_0.png)
...
![png](Exercise%204_files/Exercise%204_39_0.png)
...
![png](Exercise%204_files/Exercise%204_47_0.png)
...
![png](Exercise%204_files/Exercise%204_49_0.png)
...
![png](Exercise%204_files/Exercise%204_51_0.png)
...
omega = carseats['Income'].std()

result = np.empty(len(carseats['Income']))

for i, x in enumerate(carseats['Income']):
    z = (x - mi) / omega
    result[i] = z
...
![png](Exercise%204_files/Exercise%204_59_0.png)
...
```python
carseats['Income_Binned'] = pd.qcut(carseats['Income'], q=5, labels=['Very Low','Low', 'Medium', 'High','Very High'])

# Check the result
binning = carseats[['Income', 'Income_Binned']].head(20)
binning =binning.dropna()
print(binning)
...
```python
fixed_stage = pd.cut(carseats['Income'], bins=[20, 40, 60, 80, 100, 120], labels=['Very Low','Low', 'Medium', 'High','Very High'])
print(fixed_stage)
```
...
![png](Exercise%204_files/Exercise%204_86_0.png)
...
![png](Exercise%204_files/Exercise%204_92_1.png)
