...
```python
sns.scatterplot(x='n_convenience', y='price_twd_msq', data=df_estate)
...
```python
sns.scatterplot(x='house_age_years', y='price_twd_msq', data=df_estate)
...
```python
sns.scatterplot(x='dist_to_mrt_m', y='price_twd_msq', data=df_estate)
...
```
    ...
    C:\Users\DELL\AppData\Local\Temp\ipykernel_3280\4220897133.py:1: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
      summary = df_estate.groupby('house_age_cat_str')['price_twd_msq'].agg(['mean', 'std', 'median', 'min', 'max', 'count'])
...
```
    ...
    Time:                        11:23:32   Log-Likelihood:                -1542.5
...
<tr>
  <th>Time:</th>                 <td>11:23:34</td>     <th>  Log-Likelihood:    </th> <td> -1530.2</td>
</tr>
<tr>
...
```
    ...
    Time:                        11:23:36   Log-Likelihood:                -1525.6
