...
### Your code here
plt.figure()
sns.histplot(data=df_gapminder[df_gapminder['year'] == 2007], x='population',alpha = 0.6, stat='probability')

# i noticed that there are some outliers and it is right skewed

plt.figure()
sns.histplot(data=df_gapminder[df_gapminder['year'] == 2007], x='population', stat='probability', alpha = 0.6, log_scale=True)
```
